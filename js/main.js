$(document).ready(function () {
	...
	$(window).load(function () {
		...
		while (document.getElementById("productsmenu" + count) != null)
		{
			/*PRODUCTS MENU*/
			hermesMenu(
				hermesMenuId = 'productsmenu'+count,
			...
			hermesMenu(
				hermesMenuId = 'productschinesemenu'+count,
				hermesBarId = 'navtabs_menubar',
				hermesSynchroScroll = true,
				hermesExceptionClass = 'nobar'
			);
			...
			hermesMenu(
				hermesMenuId = 'productsback'+count,
				hermesBarId = 'navtabs_menubar',
				hermesSynchroScroll = true,
				hermesExceptionClass = 'nobar'
			);
