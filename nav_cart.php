...
try
{
	...
	else
	{
		...
		{
			$firstProductID = DecodeHTMLEntities($row["id"]);
		}
...
<nav class="navbar navbar-default navbar-fixed-top navbar-expanded" role="navigation">
  ...
  <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
    <ul id="mainmenu" class="nav navbar-nav navbar-right">
      ...
      <li class="dropdown">
        <a href="javascript:void(0);" class="dropdown-toggle" data-toggle="dropdown" onClick="location.href='products.php?id=<?php echo $firstProductID; ?>#products';">PRODUCTS <b class="caret"></b></a>
...
?>
      ...
      <li><a href="#cart">CART [<iframe id="ifNoOfItems" name="ifNoOfItems" allowtransparency="true" frameborder="0" scrolling="no" src="noofitems.php" width="20px" height="15px"></iframe>]</a></li>
